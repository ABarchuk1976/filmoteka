import { btnQueueRefs } from './queue.js';
import { getGenre } from './modal-film.js';
import { IN_LIBRARY_WATCHED, renderPagination } from './pagination.js';
...
export const btnWatchRef = document.querySelector('.js-watched');
